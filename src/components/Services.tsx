...
const services = [
  {
    name: "Solar Power",
    icon: <FaSolarPanel />,
    description: `The continent is blessed with abundant solar energy, which provides a great opportunity to
    ...
    image: "/static/images/solar-power.webp",
    classes: "",
  },
  {
    name: "Water Pumping",
    icon: <PiEngineFill />,
    description: `Africa’s major challenge that leads to low quality of life is water scarcity, especially in off-grid
    ...
    image: "/static/images/water-pumping.webp",
  },
  {
    name: "Borehole Services",
    icon: <FaTools />,
    description: `To try to bridge the gaps that lead to water scarcity, Greenovex Solutions offers Geophysical
      ...
      modern technology.`,
    image: "/static/images/borehole-services.webp",
  },
  {
    name: "Water Treatment",
    icon: <GiWaterRecycling />,
    description: `Water portability is among the causes of water scarcity in some parts of the world.
    ...
    image: "/static/images/water-treatment.webp",
  },
];
    ...
    >
      ...
      <div className="flex flex-row flex-nowrap items-center justify-between border border-white rounded-full p-1 mt-6 md:mt-3 w-auto md:w-auto">
        {services.map((service) => (
          <button
            key={service.name}
            className={`flex cursor-pointer items-center justify-evenly gap-4 px-4 py-2 rounded-full transition-all text-[14px]  md:text-[20px] font-medium ${
      ...
      <div className="mt-8 md:flex md:items-start md:justify-between">
        ...
        <div className="hidden w-full md:w-2/2 lg:w-3/4 md:grid grid-cols-1 gap-4 md:mt-8">
          <img
            src={activeService.image}
            alt={activeService.name}
            loading="lazy"
            className={`rounded-xl w-[600px] ${activeService.classes}`}
          />
          <img
            src={activeService.image}
            alt={activeService.name}
            loading="lazy"
            className="rounded-xl w-[600px] md:hidden"
          />
        </div>

        {/* Service Text */}
        <div className="mt-5  md:mt-8 w-full md:w-1/2">
        ...
        <div className="md:hidden md:w-full grid md:grid-cols-2 gap-2 mt-8">
          <img
            src={activeService.image}
            alt={activeService.name}
            loading="lazy"
